...
public class User extends UserInfo {
	...
	public User(int id, String nick, String password, String name, String surname, String email, int phone, String country, String address,
			boolean isAdministrator, Photo photo) {
		super(id, nick, name, surname, email, phone, country, address, isAdministrator, photo);
